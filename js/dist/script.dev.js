...
var content = [Number.MIN_SAFE_INTEGER, getPosition(patientContent), getPosition(cliniciansContent), getPosition(pagContent), getPosition(researchersContent), getPosition(ourStoryContent), getPosition(clientsContent), getPosition(contactContent)];
var currentIndex = 0;
